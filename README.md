...
```bash
docker rmi -f uipath-orchestrator:1.0
...
# make the process-level environment variables set
...
# check if uipath webserver is up
$response = Invoke-WebRequest http://localhost -UseBasicParsing; 
$content = $response.Content;

if( ($content -like "*UiPath*") -and ($response.StatusCode -eq 200)) {
    Write-Host "UiPath Orchestrator page is up..."
    # Start the service monitor process
    C:\start_servicemonitor.ps1
}
else 
{
    # Start the installation
    Write-Host "UiPath Orchestrator is not running..."
    powershell.exe -ExecutionPolicy Bypass -File ".\Install-UiPathOrchestrator.ps1" -OrchestratorVersion $env:ORCHESTRATOR_VERSION -orchestratorFolder "C:\Program Files\UiPath\Orchestrator" -passphrase $env:PASSPHRASE -databaseServerName $env:DATABASE_SERVER_NAME -databaseName $env:DATABASE_NAME  -databaseUserName $env:DATABASE_USERNAME -databaseUserPassword $env:DATABASE_USER_PASSWORD -orchestratorAdminPassword "Pa12312aassW05D"  -appPoolIdentityType "USER" -appPoolIdentityUser "apppool_uipath" -appPoolIdentityUserPassword "Password123!@#"

#    powershell.exe -ExecutionPolicy Bypass -File ".\Install-UiPathOrchestrator.ps1" -OrchestratorVersion "$env:ORCHESTRATOR_VERSION" -orchestratorFolder "$env:ORCHESTRATOR_FOLDER" -passphrase "$env:PASSPHRASE" -databaseServerName "$env:DATABASE_SERVER_NAME" -databaseName "$env:DATABASE_NAME"  -databaseUserName "$env:DATABASE_USERNAME" -databaseUserPassword "$env:DATABASE_USER_PASSWORD" -orchestratorAdminPassword "$env:ORCHESTRATOR_ADMIN_PASSWORD" -appPoolIdentityType "$env:APPPOOL_IDENTITY_TYPE" -appPoolIdentityUser "$env:APPPOOL_IDENTITY_USER" -appPoolIdentityUserPassword "$env:APPPOOL_IDENTITY_USER_PASSWORD"
#    powershell.exe -ExecutionPolicy Bypass -File ".\Install-UiPathOrchestrator.ps1" -OrchestratorVersion "19.4.3" -orchestratorFolder "C:\Program Files\UiPath\Orchestrator" -passphrase "AnyPassPhrase!@#$" -databaseServerName  "34.66.48.161"  -databaseName "uipath"  -databaseUserName "uipath" -databaseUserPassword "TZ27cLgG3X1Gut9GOJeC" -orchestratorAdminPassword "P@ssW05D!" -appPoolIdentityType "USER" -appPoolIdentityUser "apppool_uipath" -appPoolIdentityUserPassword "Password123!@#"
...
RUN dism /online /get-featureinfo /featurename:IIS-WebServer  /NoRestart
...
COPY setup_iis_user.ps1 .
COPY start_servicemonitor.ps1 .

RUN  powershell.exe -ExecutionPolicy Bypass -File ".\setup_iis_user.ps1"

COPY Install-UiPathOrchestrator.ps1 .
...
* Nanoserver is missing ClientForNFS-Infrastructure

PS C:\temp\log> type .\Install-Orchestrator.ps1.log
Installing feature IIS-DefaultDocument
Installing feature IIS-HttpErrors
Installing feature IIS-StaticContent
Installing feature IIS-RequestFiltering
Installing feature IIS-URLAuthorization
Installing feature IIS-WindowsAuthentication
Installing feature IIS-NetFxExtensibility45
Installing feature IIS-ASPNET45
Installing feature IIS-ISAPIExtensions
Installing feature IIS-ISAPIFilter
Installing feature IIS-WebSockets
Installing feature IIS-ManagementConsole
Installing feature IIS-ManagementScriptingTools
PS C:\temp\log> dir
...
----                -------------         ------ ----
-a----       11/12/2019   2:26 PM           1146 Install-Orchestrator.ps1.log
-a----       11/12/2019   2:26 PM           2239 Install-UipathOrchestrator-Transcript.ps1.txt
...
Installing feature IIS-ManagementConsole
Installing feature IIS-ManagementScriptingTools
Installing feature ClientForNFS-Infrastructure
Error: An error has occurred [The source files could not be found.
Use the "Source" option to specify the location of the files that are required to restore the feature. For more information on specifying a source location, see http://go.microsoft.com/fwlink/?LinkId=243077.
 on installing ClientForNFS-Infrastructure].

***************************************************************************************************
Finished processing at [11/12/2019 14:26:01].
***************************************************************************************************

PS C:\temp\log>


* UiPath.OrchestratorCAs!UiPath.OrchestratorCAs.CustomActions.ConfigureIis

MSI (s) (8C:BC) [15:33:50:887]: Executing op: CustomActionSchedule(Action=Orchestrator_ConfigureIis_Rollback,ActionType=3329,Source=BinaryData,Target=RollbackConfigureIis,CustomActionData=WEBSITE
_NAME=UiPath Orchestrator;APPPOOL_NAME=UiPath Orchestrator)
MSI (s) (8C:BC) [15:33:50:950]: Executing op: ActionStart(Name=Orchestrator_ConfigureIis,Description=Configuring IIS,)
MSI (s) (8C:BC) [15:33:50:962]: Executing op: CustomActionSchedule(Action=Orchestrator_ConfigureIis,ActionType=3073,Source=BinaryData,Target=ConfigureIis,CustomActionData=ORCHESTRATORFOLDER=C:\Pr
ogram Files (x86)\UiPath\Orchestrator\;WEBSITE_NAME=UiPath Orchestrator;WEBSITE_PROTOCOL=https;WEBSITE_PORT=443;WEBSITE_HOST=8301553D3F31;APPPOOL_NAME=UiPath Orchestrator;

APPPOOL_IDENTITY_TYPE=APPPOOLIDENTITY;
APPPOOL_USER_NAME=;APPPOOL_PASSWORD=;HAS_IIS_8_PLUS=true;CERTIFICATE_SUBJECT=8301553D3F31;NUGET_FOLDER=)
MSI (s) (8C:BC) [15:33:50:974]: Creating MSIHANDLE (308) of type 790536 for thread 10172
MSI (s) (8C:98) [15:33:50:976]: Invoking remote custom action. DLL: C:\Windows\Installer\MSI7453.tmp, Entrypoint: ConfigureIis
MSI (s) (8C!C0) [15:33:51:220]: Creating MSIHANDLE (309) of type 790531 for thread 5312
MSI (s) (8C!C0) [15:33:51:221]: Closing MSIHANDLE (309) of type 790531 for thread 5312
MSI (s) (8C!C0) [15:33:58:189]: Creating MSIHANDLE (310) of type 790531 for thread 5312
SFXCA: Extracting custom action to temporary directory: C:\Windows\Installer\MSI7453.tmp-\
MSI (s) (8C!C0) [15:33:58:191]: Closing MSIHANDLE (310) of type 790531 for thread 5312
MSI (s) (8C!C0) [15:33:58:247]: Creating MSIHANDLE (311) of type 790531 for thread 5312
SFXCA: Binding to CLR version v4.0.30319
MSI (s) (8C!C0) [15:33:58:250]: Closing MSIHANDLE (311) of type 790531 for thread 5312
MSI (s) (8C!C0) [15:33:58:600]: Creating MSIHANDLE (312) of type 790531 for thread 5312
Calling custom action UiPath.OrchestratorCAs!UiPath.OrchestratorCAs.CustomActions.ConfigureIis
MSI (s) (8C!C0) [15:33:58:632]: Creating MSIHANDLE (313) of type 790531 for thread 5312
An error has ocurred while configuring the IIS.
MSI (s) (8C!C0) [15:33:58:632]: Closing MSIHANDLE (313) of type 790531 for thread 5312
MSI (s) (8C!C0) [15:33:58:632]: Closing MSIHANDLE (312) of type 790531 for thread 5312
System.Security.Principal.IdentityNotMappedException: Some or all identity references could not be translated.
   at System.Security.Principal.NTAccount.Translate(IdentityReferenceCollection sourceAccounts, Type targetType, Boolean forceSuccess)
   at System.Security.Principal.NTAccount.Translate(Type targetType)
   at UiPath.Common.AclSettings.SetAclForUser(String path, FileSystemRights rights, String userName)
   at UiPath.OrchestratorCAs.CustomActions.ConfigureIis(Session session)



   configurationService.SetOrchestratorPermissions(userName, text2);

// UiPath.OrchestratorCAs.ConfigurationService
using System.Security.AccessControl;
using UiPath.Orchestrator.Setup.Configuration.Helpers;

public void SetOrchestratorPermissions(string userName, string orchestratorFolder)
{
	if (!string.IsNullOrWhiteSpace(orchestratorFolder))
	{
		AclSettings.SetAclForUser(orchestratorFolder, FileSystemRights.ReadAndExecute, userName);
	}
}


MSI (s) (8C:98) [15:33:58:711]: Closing MSIHANDLE (308) of type 790536 for thread 10172
CustomAction Orchestrator_ConfigureIis returned actual error code 1603 (note this may not be 100% accurate if translation happened inside sandbox)
MSI (s) (8C:BC) [15:33:58:741]: Note: 1: 2265 2:  3: -2147287035
MSI (s) (8C:BC) [15:33:58:742]: User policy value 'DisableRollback' is 0
MSI (s) (8C:BC) [15:33:58:742]: Machine policy value 'DisableRollback' is 0
Action ended 15:33:58: InstallFinalize. Return value 3.
MSI (s) (8C:BC) [15:33:58:743]: Note: 1: 2318 2:
MSI (s) (8C:BC) [15:33:58:769]: Executing op: Header(Signature=1397708873,Version=500,Timestamp=1332509738,LangId=1033,Platform=0,ScriptType=2,ScriptMajorVersion=21,ScriptMinorVersion=4,ScriptAtt
ributes=1)
MSI (s) (8C:BC) [15:33:58:769]: Executing op: DialogInfo(Type=0,Argument=1033)
MSI (s) (8C:BC) [15:33:58:770]: Executing op: DialogInfo(Type=1,Argument=UiPath Orchestrator)
MSI (s) (8C:BC) [15:33:58:770]: Executing op: RollbackInfo(,RollbackAction=Rollback,RollbackDescription=Rolling back action:,RollbackTemplate=[1],CleanupAction=RollbackCleanup,CleanupDescription=
Removing backup files,CleanupTemplate=File: [1])
MSI (s) (8C:BC) [15:33:58:771]: Executing op: ActionStart(Name=Orchestrator_ConfigureIis,Description=Configuring IIS,)
MSI (s) (8C:BC) [15:33:58:771]: Executing op: ProductInfo(ProductKey={88F2B94A-8B0F-4700-9E23-A8DC05C390A7},ProductName=UiPath Orchestrator,PackageName=UiPathOrchestrator.msi,Language=1033,Versio
n=319029251,Assignment=1,ObsoleteArg=0,ProductIcon=logo_Studio.ico,,PackageCode={2F41D690-C069-4DAB-8A60-A894C38923B3},,,InstanceType=0,LUASetting=0,RemoteURTInstalls=0,ProductDeploymentFlags=3)
MSI (s) (8C:BC) [15:33:58:772]: Executing op: ActionStart(Name=Orchestrator_ConfigureIis_Rollback,Description=Configuring IIS,)
MSI (s) (8C:BC) [15:33:58:783]: Executing op: CustomActionRollback(Action=Orchestrator_ConfigureIis_Rollback,ActionType=3329,Source=BinaryData,Target=RollbackConfigureIis,CustomActionData=WEBSITE
_NAME=UiPath Orchestrator;APPPOOL_NAME=UiPath Orchestrator)
MSI (s) (8C:BC) [15:33:58:797]: Creating MSIHANDLE (314) of type 790536 for thread 10172
MSI (s) (8C:58) [15:33:58:798]: Invoking remote custom action. DLL: C:\Windows\Installer\MSI92E8.tmp, Entrypoint: RollbackConfigureIis
MSI (s) (8C!7C) [15:33:58:989]: Creating MSIHANDLE (315) of type 790531 for thread 9340
MSI (s) (8C!7C) [15:33:58:990]: Closing MSIHANDLE (315) of type 790531 for thread 9340
MSI (s) (8C!7C) [15:34:04:891]: Creating MSIHANDLE (316) of type 790531 for thread 9340
SFXCA: Extracting custom action to temporary directory: C:\Windows\Installer\MSI92E8.tmp-\
MSI (s) (8C!7C) [15:34:04:892]: Closing MSIHANDLE (316) of type 790531 for thread 9340
MSI (s) (8C!7C) [15:34:04:970]: Creating MSIHANDLE (317) of type 790531 for thread 9340
SFXCA: Binding to CLR version v4.0.30319
MSI (s) (8C!7C) [15:34:04:978]: Closing MSIHANDLE (317) of type 790531 for thread 9340
MSI (s) (8C!7C) [15:34:05:354]: Creating MSIHANDLE (318) of type 790531 for thread 9340
Calling custom action UiPath.OrchestratorCAs!UiPath.OrchestratorCAs.CustomActions.RollbackConfigureIis
```
...
docker run -d -p 8080:80 --name=uipath --env ORCHESTRATOR_VERSION="19.4.3" --env ORCHESTRATOR_FOLDER="C:\Program Files\UiPath\Orchestrator" --env PASSPHRASE="AnyPassPhrase213123124124#" --env DATABASE_SERVER_NAME="34.66.48.161" --env DATABASE_NAME="uipath" --env DATABASE_USERNAME="uipath" --env DATABASE_USER_PASSWORD="TZ27cLgG3X1Gut9GOJeC" --env ORCHESTRATOR_ADMIN_PASSWORD="Pa12312aassW05D" --env APPPOOL_IDENTITY_TYPE="USER" --env APPPOOL_IDENTITY_USER="apppool_uipath" --env APPPOOL_IDENTITY_USER_PASSWORD="Password123!@" uipath-orchestrator:1.0    
